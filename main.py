...
# --- DEPENDÊNCIAS (EXPANDIDA CORRETAMENTE) ---
def get_db():
    db = SessionLocal()
    try:
        yield db
...
/* MODAL FIX */
.modal{position:fixed;inset:0;background:#0b0c10;z-index:9000;display:flex;align-items:center;justify-content:center} /* FUNDO SÓLIDO */
