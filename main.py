...
const T = {
    'pt': {
        ...
        'edit_base': 'EDITAR BASE', 'base_avatar': 'Novo Avatar', 'base_banner': 'Novo Banner (Base e Geral)',
    ...
    'en': {
        ...
        'edit_base': 'EDIT BASE', 'base_avatar': 'New Avatar', 'base_banner': 'New Banner (Base & General)',
    ...
    'es': {
        ...
        'edit_base': 'EDITAR BASE', 'base_avatar': 'Nuevo Avatar', 'base_banner': 'Nuevo Banner (Base y General)',
...
async function openCommunity(cid) {
    ...
    try {
        ...
        document.getElementById('comm-header').style.backgroundImage = headerBg;
        ...
        if(d.creator_id === user.id) {
            delCont.innerHTML = `
                <button class="glass-btn" style="width:100%; margin-bottom:10px; color:#2ecc71; border-color:#2ecc71;" onclick="document.getElementById('modal-edit-comm').classList.remove('hidden')">✏️ EDITAR BASE</button>
                <button class="glass-btn danger-btn" onclick="confirmDelete('base', ${cid})">${t('destroy_base')}</button>
            `; 
        } else { delCont.innerHTML = ''; }
